...
public class TesteInserirTexto {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        objTutorialTexto.setTipo_tutorial(texto("Tipo de tutorial (TEXTO OU VIDEO)"));
        objTutorialTexto.setTextoTutorial(texto("Texto do tutorial"));

        System.out.println(tutorialTextoDAO.inserirTextoTutorial(objTutorialTexto));
    }
}
