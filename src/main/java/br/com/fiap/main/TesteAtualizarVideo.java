...
public class TesteAtualizarVideo {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        objTutorialVideo.setId_tutorial(inteiro("Informe o Id do tutorial que será atualizado"));
        objTutorialVideo.setTitulo(texto("Informe o titulo que sera atualizado"));
        objTutorialVideo.setUrl(texto("Informe o link do video que sera atualizado"));
        objTutorialVideo.setTipo_tutorial(texto("Informe o novo tipo de tutorial"));



        System.out.println(tutorialVideoDAO.atualizarVideoTutorial(objTutorialVideo));
    }
}
